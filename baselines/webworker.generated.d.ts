...
interface SubtleCrypto {
    ...
    unwrapKey(format: string, wrappedKey: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer, unwrappingKey: CryptoKey, unwrapAlgorithm: string | Algorithm | RsaOaepParams | RsaKeyAlgorithm | RsaHashedKeyAlgorithm | AesCbcParams | AesCtrParams | AesGcmParams, unwrappedKeyAlgorithm: string | Algorithm | RsaHashedImportParams | EcKeyImportParams | HmacImportParams, extractable: boolean, keyUsages: string[]): PromiseLike<CryptoKey>;
    ...
    wrapKey(format: string, key: CryptoKey, wrappingKey: CryptoKey, wrapAlgorithm: string | Algorithm | RsaOaepParams | RsaKeyAlgorithm | RsaHashedKeyAlgorithm | AesCbcParams | AesCtrParams | AesGcmParams): PromiseLike<ArrayBuffer>;
}
