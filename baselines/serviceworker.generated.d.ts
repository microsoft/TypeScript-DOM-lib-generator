...
declare function addEventListener<K extends keyof ServiceWorkerGlobalScopeEventMap>(type: K, /** @deferred */ listener: (this: ServiceWorkerGlobalScope, ev: ServiceWorkerGlobalScopeEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
...
declare function removeEventListener<K extends keyof ServiceWorkerGlobalScopeEventMap>(type: K, /** @deferred */ listener: (this: ServiceWorkerGlobalScope, ev: ServiceWorkerGlobalScopeEventMap[K]) => any, options?: boolean | EventListenerOptions): void;
