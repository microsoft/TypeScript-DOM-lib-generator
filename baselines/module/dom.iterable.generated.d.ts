...
export interface CustomStateSet extends Set<string> {
}
...
export interface Highlight extends Set<AbstractRange> {
}

export interface HighlightRegistry extends Map<string, Highlight> {
}
...
export interface ViewTransitionTypeSet extends Set<string> {
}
