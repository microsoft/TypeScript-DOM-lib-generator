...
export interface DedicatedWorkerGlobalScopeEventMap extends WorkerGlobalScopeEventMap, MessageEventTargetEventMap {
    "message": MessageEvent;
    "messageerror": MessageEvent;
 ...
 */
export interface DedicatedWorkerGlobalScope extends WorkerGlobalScope, AnimationFrameProvider, MessageEventTarget {
    /**
...
export interface MessagePortEventMap extends MessageEventTargetEventMap {
    "message": MessageEvent;
    "messageerror": MessageEvent;
}
 ...
 */
export interface MessagePort extends EventTarget, MessageEventTarget {
    /**
...
export interface RTCRtpScriptTransformer extends EventTarget {
...
export interface SharedWorkerGlobalScopeEventMap extends WorkerGlobalScopeEventMap {
...
export interface WorkerEventMap extends AbstractWorkerEventMap, MessageEventTargetEventMap {
    "message": MessageEvent;
    "messageerror": MessageEvent;
}
 ...
 */
export interface Worker extends EventTarget, AbstractWorker, MessageEventTarget {
    /**
 ...
 */
export interface WorkerNavigator extends NavigatorBadge, NavigatorConcurrentHardware, NavigatorID, NavigatorLanguage, NavigatorLocks, NavigatorOnLine, NavigatorStorage {
...
declare namespace WebAssembly {
    ...
    export interface Global<T extends ValueType = ValueType> {
...
export type CSSPerspectiveValue = CSSNumericValue | CSSKeywordish;
export type CSSUnparsedSegment = string | CSSVariableReferenceValue;
export type CanvasImageSource = ImageBitmap | OffscreenCanvas | VideoFrame;
...
export type TexImageSource = ImageBitmap | ImageData | OffscreenCanvas | VideoFrame;
export type TimerHandler = string | Function;
export type Transferable = OffscreenCanvas | ImageBitmap | MessagePort | MediaSourceHandle | ReadableStream | WritableStream | TransformStream | AudioData | VideoFrame | RTCDataChannel | ArrayBuffer;
...
export type AudioSampleFormat = "f32" | "f32-planar" | "s16" | "s16-planar" | "s32" | "s32-planar" | "u8" | "u8-planar";
...
export type CodecState = "closed" | "configured" | "unconfigured";
...
export type EncodedAudioChunkType = "delta" | "key";
export type EncodedVideoChunkType = "delta" | "key";
...
export type FrameType = "auxiliary" | "nested" | "none" | "top-level";
...
export type OpusBitstreamFormat = "ogg" | "opus";
export type PermissionName = "camera" | "geolocation" | "microphone" | "midi" | "notifications" | "persistent-storage" | "push" | "screen-wake-lock" | "storage-access";
...
export type VideoEncoderBitrateMode = "constant" | "quantizer" | "variable";
...
export type VideoTransferCharacteristics = "bt709" | "iec61966-2-1" | "smpte170m";
export type WebGLPowerPreference = "default" | "high-performance" | "low-power";
export type WebTransportCongestionControl = "default" | "low-latency" | "throughput";
export type WebTransportErrorSource = "session" | "stream";
