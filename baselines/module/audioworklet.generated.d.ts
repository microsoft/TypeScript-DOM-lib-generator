...
export interface AudioWorkletGlobalScope extends WorkletGlobalScope {
...
export type Transferable = MessagePort | ReadableStream | WritableStream | TransformStream | ArrayBuffer;
